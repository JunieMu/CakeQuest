...
public class Level2World extends World {
    ...
    public Level2World() 
    {
        // set the background image to the arctic image
        setBackground("img/BG/arctic.jpeg");
        
        // make the Icon image for the score
        Icon scoreIcon = new Icon("img/Object/milk.png");
    ...
    public void buildWorld() {
        ...
        for(int r = 0; r < tiles.length; r++) {
            for(int c = 0; c < tiles[r].length; c++) {
                ...
                ArcticBlock ice = new ArcticBlock();
                if(tiles[r][c].equals("ground"))
                    addObject(ice, c * 125, r * 95);
                ...
                if((num == 10 || num == 11) && tiles[randomY][c].equals("")) {
                    addObject(new Milk(), c * 125, randomY * 95);
                    tiles[randomY][c] = "milk";
                }
                ...
                if(num > 20 && tiles[r][c].equals("ground") && tiles[r-1][c].equals("")) {
                    addObject(new Stone(), c * 125, (r-1) * 105);
                    tiles[r-1][c] = "stone";
                }      
            }
        }
